...
function ControlButtons({
  ...
  return (
   <div className="container bg-gray-800 rounded-xl shadow-lg p-4 mb-6">
  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
    ...
    />
    <button
      className="btn-primary cursor-pointer flex items-center justify-center h-12"
    ...
    <input
      ...
      onChange={(e) => {
        if (e.target.files[0]) {
          ...
          handle_OpenImage(URL.createObjectURL(file));
          e.target.value = null;
        }
      }}
    />
    <button
      className={`flex cursor-pointer items-center justify-center h-12 ${
...
function App() {
  ...
  return (
    <div className=" mx-auto px-2 sm:px-4 lg:px-6 py-4 sm:py-6  bg-linear-to-br from-slate-900 via-blue-900 to-slate-900 min-h-screen">
  {/* <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-center mb-4 sm:mb-6 
               text-slate-200 tracking-tight drop-shadow-md">
  <span className="block sm:inline">Traffic</span>
<span className="block sm:inline bg-gradient-to-r from-blue-800 via-blue-700 to-blue-600
